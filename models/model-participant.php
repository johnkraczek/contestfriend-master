...
/**
* Model: cf_Participant.
* @package chModel
*/

/**
* Model class <i>cf_Participant</i> represents participant.
* @package chModel
*/
class cf_Participant
{
    /**
    ...
    */
    protected function get($id, $ref = false)
    {
        ...
        $tbl_participant = $wpdb->prefix.cf_Manager::sqlt_participant;
        $tbl_participantmeta = $wpdb->prefix.cf_Manager::sqlt_participant_meta;
    ...
    */
    ...
    /**
    * Runs customizable SELECT database query and returns array of <i>cf_Participant</i> objects.
    ...
    * @return mixed Array of cf_Participant objects or empty array.
    */
    static function get_all($contest_id = '', $in_orderby = '', $in_order = '', $in_page = '', $in_perpage = '', $in_status = '')
    {
        ...
        $tbl_participant = $wpdb->prefix.cf_Manager::sqlt_participant;
        $tbl_participant_meta = $wpdb->prefix.cf_Manager::sqlt_participant_meta;
