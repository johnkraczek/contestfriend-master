...
class Campaign extends CCObject{
    ...
    public function __construct($params=array()){
		...
		$this->inchorwardEmail = (isset($params['inchorwardEmail'])) ? $params['inchorwardEmail'] : 'NO';
    ...
    public function createXml(){
        ...
        $campaign_node->addchild("IncludeForwardEmail", $this->inchorwardEmail);
    ...
    public static function createStruct($parsedReturn){
        ...
        $campaign['inchorwardEmail'] = (string) $parsedReturn->content->Campaign->IncludeForwardEmail;
