...
class AWeberCollection extends AWeberResponse implements ArrayAccess, Iterator, Countable {
     ...
     *
     * @param mixed $searcf_data   Associative array of key/value pairs used as search filters
     ...
     */
    public function find($searcf_data) {
        # invoke find operation
        $params = array_merge($searcf_data, array('ws.op' => 'find'));
